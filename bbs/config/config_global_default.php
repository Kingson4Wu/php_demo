...
$_config['app']['domain']['forum']		= '';		//论坛绑定域名
$_config['app']['domain']['group']		= '';		//群组绑定域名
$_config['app']['domain']['home']		= '';		//用户中心绑定域名
$_config['app']['domain']['portal']		= '';		//门户绑定域名
$_config['app']['domain']['mobile']		= '';		//手机模式绑定域名
...
$_config['security']['attackevasive']		= 0;		//cc 防御  1|2|4
...
//家园二级域名设置
$_config['home']['allowdomain'] = 0;		//个人空间是否启用二级域名 1=是 0=否
$_config['home']['domainroot'] = '';		//二级域名根域名，例如：discuz.net
$_config['home']['holddomain'] = 'www,space,home,forum,portal';		//保留的二级域名，多个之间使用逗号",”分开
