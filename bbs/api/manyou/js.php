 ...
 *
 *      $Id: js.php 10860 2010-05-17 09:29:31Z zhaoxiongfei $
 */
		...
		if($_G['uid']) {
			...
			if($_G['group']['allowinvisible']) {
				...
				if($_G['uid'] && $_G['adminid'] > 1) {
					$rightHtmlCode .= "\t<span class=\"pipe\">|</span><a href=\"forum.php?mod=modcp&fid=$_G[fid]\" target=\"_blank\">".$_G['setting']['navs']['2']['navname'].lang('template', 'manager')."</a>\n";
				}
			...
			$rightHtmlCode .= "\t<a href=\"member.php?mod=register\" class=\"noborder\">".$_G['setting']['reglinkname']."</a>\n";
