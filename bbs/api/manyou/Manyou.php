 ...
 *
 *      $Id: Manyou.php 10915 2010-05-18 04:48:02Z monkey $
 */
...
<div id="loading" style="display:block; padding:100px 0; text-align:center; color:#999999; font-size:12px;">页面加载中...</div>
...
class SearchHelper {
	...
	function preGetThreads($table, $tIds) {
		$sql = sprintf("SELECT * FROM %s WHERE tid IN (%s) AND displayorder >= 0", $table, implode($tIds, ', '));
