/*
	...
	$Id: forum_post.js 10896 2010-05-18 02:42:40Z monkey $
*/
...
function updateAttachList(action) {
	ajaxget('forum.php?mod=ajax&action=attachlist&posttime=' + $('posttime').value, 'attachlist');
	switchAttachbutton('attachlist');$('attach_tblheader').style.display = $('attach_notice').style.display = '';
}

function updateImageList(action) {
	ajaxget('forum.php?mod=ajax&action=imagelist&pid=' + pid + '&posttime=' + $('posttime').value, 'imgattachlist');
