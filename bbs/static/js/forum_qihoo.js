/*
	...
	$Id: forum_qihoo.js 3235 2010-01-27 08:40:10Z liulanbo $
*/
...
function qihoothreads(num) {
	...
	if(num) {
		for(i = 0; i < num; i++) {
			threadslist += "<tr><td><a href=\"forum.php?mod=viewthread&tid=" + qihoo_threads[i][1] + "\" target=\"_blank\">" + qihoo_threads[i][0] + "</a></td>" +
				"<td><a href=\"forum.php?mod=forumdisplay&fid=" + qihoo_threads[i][8] + "\" target=\"_blank\">" + qihoo_threads[i][2] + "</a></td>" +
				"<td><a href=\"home.php?mod=space&username=" + qihoo_threads[i][3] + "\" target=\"_blank\">" + qihoo_threads[i][3] + "</a><br />" + qihoo_threads[i][6] + "</td>" +
