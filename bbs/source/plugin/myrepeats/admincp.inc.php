 ...
 *
 *      $Id: admincp.inc.php 6752 2010-03-25 08:47:54Z cnteacher $
 */
...
echo multi($count, $ppp, $page, ADMINSCRIPT."?action=plugins&operation=config&do='.$pluginid.'&identifier=myrepeats&mod=admincp$extra");
