...
if($isfounder) {
	loaducenter();
	$uc_api_url = UC_API;
	echo '<li><em><a id="header_uc" hidefocus="true" href="'.UC_API.'/admin.php?m=frame" onclick="uc_login=1;toggleMenu(\'uc\', \'\');doane(event);">'.cplang('header_uc').'</a></em></li>';
	$topmenu['uc'] = '';
}
...
<script type="text/JavaScript">
	...
	function initCpMap() {
		var ul, hrefs, s;
		s = '<ul class="cnote"><li style="margin-right:5px"><a href="javascript:;" onclick="hideMenu()"><img src="static/image/admincp/btn_map.gif" /></a></li><li><h3>$lang[admincp_maptitle]</h3></li></ul><table class="cmlist" id="mapmenu"><tr>';
