 ...
 *
 *      $Id: admincp_group.php 10844 2010-05-17 06:54:41Z wangjinbo $
 */
...
<?
	...
	if(!submitcheck('editsubmit')) {
		...
		DB::query("UPDATE ".DB::table('forum_forum')." SET name = '$_G[gp_namenew]', displayorder = '$_G[gp_ordernew]'$fupsql WHERE fid='$fid'");
