 ...
 *
 *      $Id: admincp_tradelog.php 6995 2010-03-28 01:59:02Z monkey $
 */
...
$count = DB::fetch_first("SELECT sum(price) AS pricesum, sum(credit) AS creditsum, sum(tax) AS taxsum FROM ".DB::table('forum_tradelog')." status $sqlfilter");
