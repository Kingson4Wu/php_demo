 ...
 *
 *      $Id: admincp_prune.php 10758 2010-05-14 08:56:53Z zhaoxiongfei $
 */
...
if(submitcheck('searchsubmit')) {
	...
	showsubmit('prunesubmit', 'submit', $_G['gp_detail'] ? 'del' : '', '<input class="checkbox" type="checkbox" name="donotupdatemember" id="donotupdatemember" value="1" checked="checked" /><label for="donotupdatemember"> '.cplang('prune_no_update_member').'</label>', $multi);
	showtablefooter();
	showformfooter();
