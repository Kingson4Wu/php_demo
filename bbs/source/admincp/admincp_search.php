 ...
 *
 *      $Id: admincp_search.php 9928 2010-05-05 08:42:52Z liulanbo $
 */
	...
	if($result) {
		...
		foreach($result as $item) {
			if($is[$item[0]]) {
				...
				$results[$item[0]] .= '<div class="news"><a href="'.$preurl.'&highlight='.rawurlencode($keywords).'"  target="_blank">'.$item[1].'</a></div>';
				$count++;
			}
		}
		if($count) {
