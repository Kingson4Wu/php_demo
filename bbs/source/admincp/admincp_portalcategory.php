 ...
 *
 *      $Id: admincp_portalcategory.php 10877 2010-05-18 01:42:46Z xupeng $
 */
...
if($operation == 'list') {
	...
	if(!submitcheck('editsubmit')) {
		...
		echo '<tr><td>&nbsp;</td><td><div><a class="addtr" onclick="addcategory(this, 0, 0)" href="###">'.cplang('portalcategory_addcategory').'</a></div></td><td>&nbsp;</td></tr>';
