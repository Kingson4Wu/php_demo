 ...
 *
 *      $Id: admincp_setting.php 10954 2010-05-18 09:16:56Z monkey $
 */
...
if(!submitcheck('settingsubmit')) {
	...
	if($operation == 'basic') {
		...
		showsetting('setting_home_base_allowdomain', 'settingnew[allowdomain]', $setting['allowdomain'], 'radio', '', 1);
		showsetting('setting_home_base_holddomain', 'settingnew[holddomain]', $setting['holddomain'], 'text');
		showsetting('setting_home_base_domainroot', 'settingnew[domainroot]', $setting['domainroot'], 'text');
		showtablefooter();
		...
		showsetting('setting_styles_global_stylejump', 'settingnew[stylejump]', $setting['stylejump'], 'radio');
		...
		showsetting('setting_sec_seccode_loginfailedcount', 'settingnew[seccodedata][loginfailedcount]', $setting['seccodedata']['loginfailedcount'], 'radio');
...
EOT;
		...
		if($isfounder) {
			showsubtitle(array($lang['setting_attach_remote'], ''));
	...
	if(isset($settingnew['creditsformula']) && isset($settingnew['extcredits']) && isset($settingnew['initcredits']) && isset($settingnew['creditstrans']) && isset($settingnew['creditstax'])) {
		...
		foreach(array('digestposts', 'posts', 'threads', 'extcredits1', 'extcredits2', 'extcredits3', 'extcredits4', 'extcredits5', 'extcredits6', 'extcredits7', 'extcredits8') as $var) {
	...
	if(isset($settingnew['seccodedata'])) {
		...
		$settingnew['seccodedata']['loginfailedcount'] = !empty($settingnew['seccodedata']['loginfailedcount']) ? 3 : 0;
