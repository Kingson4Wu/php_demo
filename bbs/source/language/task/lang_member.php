 ...
 *
 *      $Id: lang_member.php 6752 2010-03-25 08:47:54Z cnteacher $
 */

$lang = array
(
	'member_name' => '会员类任务',
	'member_desc' => '添加好友、收藏主题、使用道具，此类任务用来鼓励和引导会员使用论坛的某个功能，活跃论坛的氛围。',
	'member_complete_var_act' => '动作',
	'member_complete_var_act_buddy' => '添加好友',
	...
	'task_complete_act_buddy' => '添加 {value} 个好友。',
	'task_complete_act_favorite' => '收藏 {value} 个主题。',
	'task_complete_act_magic' => '使用 {value} 次道具。',
);
