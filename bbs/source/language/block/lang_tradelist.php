 ...
 *
 *      $Id: lang_tradelist.php 6757 2010-03-25 09:01:29Z cnteacher $
 */
...
(
	...
	'tradelist_uids' => '指定用户',
	'tradelist_uids_comment' => '设置要指定显示的用户 uid ，多个 uid 请用半角逗号“,”隔开。注意: 留空为不进行任何过滤',
	...
	'tradelist_keyword_comment' => '设置标题包含的关键字。注意: 留空为不进行任何过滤<br />关键字中可使用通配符 "*"<br />匹配多个关键字全部，可用空格或 "AND" 连接。如 win32 AND unix<br />匹配多个关键字其中部分，可用 "|" 或 "OR" 连接。如 win32 OR unix',
