 ...
 *
 *      $Id: lang_sortlist.php 6757 2010-03-25 09:01:29Z cnteacher $
 */
...
(
	...
	'sortlist_keyword_comment' => '设置标题包含的关键字。注意: 留空为不进行任何过滤<br />关键字中可使用通配符 "*"<br />匹配多个关键字全部，可用空格或 "AND" 连接。如 win32 AND unix<br />匹配多个关键字其中部分，可用 "|" 或 "OR" 连接。如 win32 OR unix',
	...
	'sortlist_orderby_hourviews' => '按指定时间内浏览次数倒序排序',
	'sortlist_orderby_todayviews' => '按当天浏览次数倒序排序',
	'sortlist_orderby_weekviews' => '按本周浏览次数倒序排序',
	'sortlist_orderby_monthviews' => '按当月浏览次数倒序排序',
	'sortlist_orderby_hours' => '指定时间(小时)',
