 ...
 *
 *      $Id: lang_wap.php 6752 2010-03-25 08:47:54Z cnteacher $
 */
...
(
	...
	'register_ctrl' => '对不起，您的 IP 地址在 {$_G[setting][regctrl]} 小时内只能注册一个帐号，请返回。',
	...
	'register_activation_message' => '对不起，您输入的用户名 \"$username\" 已经存在，请登录论坛激活此帐号<br /><a href=\"forum.php?mod=index&action=login\">登录论坛</a>',
	...
	'post_newbie_span' => '注册{{$_G[setting][newbiespan]}}小时后才可发帖',
	...
	'search_ctrl' => '对不起，您在 {$_G[setting][searchctrl]} 秒内只能进行一次搜索，请返回。',
