 ...
 *
 *      $Id: lang_message.php 10837 2010-05-17 06:27:54Z monkey $
 */
...
(
	...
	'viewperm_none_nopermission' => '对不起，您无权访问该版块，详细请<a href="home.php?mod=spacecp&ac=credit&op=usergroup" target="_blank">点击这里查看</a></p></div><div>',
	'viewperm_upgrade_nopermission' => '对不起，您需要升级您所在的用户组后才能访问该版块，详细请<a href="home.php?mod=spacecp&ac=credit&op=usergroup" target="_blank">点击这里查看</a></p></div><div><p><b>有权访问的用户组为:</b><br />&nbsp;&nbsp;&nbsp; {permgroups}',
	'viewperm_login_nopermission' => '对不起，您还未登录，无权访问该版块。',
	'postperm_none_nopermission' => '对不起，您无权在该版块发帖，详细请<a href="home.php?mod=spacecp&ac=credit&op=usergroup" target="_blank">点击这里查看</a></p></div><div>',
	'postperm_upgrade_nopermission' => '对不起，您需要升级您所在的用户组后才能发帖，详细请<a href="home.php?mod=spacecp&ac=credit&op=usergroup" target="_blank">点击这里查看</a></p></div><div><p><b>有权发帖的用户组为:</b><br />&nbsp;&nbsp;&nbsp; {permgroups}',
	'postperm_login_nopermission' => '对不起，您还未登录，无权在该版块发帖。',
	'replyperm_none_nopermission' => '对不起，您无权在该版块回帖，详细请见<a href="home.php?mod=spacecp&ac=credit&op=usergroup" target="_blank">点击这里查看</a></p></div><div>',
	'replyperm_upgrade_nopermission' => '对不起，您需要升级您所在的用户组后才能回帖，详细请<a href="home.php?mod=spacecp&ac=credit&op=usergroup" target="_blank">点击这里查看</a></p></div><div><p><b>有权回帖的用户组为:</b><br />&nbsp;&nbsp;&nbsp; {permgroups}',
	'replyperm_login_nopermission' => '对不起，您还未登录，无权在该版块回帖。',
	'getattachperm_none_nopermission' => '对不起，您无权下载本附件，详细请<a href="home.php?mod=spacecp&ac=credit&op=usergroup" target="_blank">点击这里查看</a></p></div><div>',
	'getattachperm_upgrade_nopermission' => '对不起，您需要升级您所在的用户组后才能下载本附件，详细请<a href="home.php?mod=spacecp&ac=credit&op=usergroup" target="_blank">点击这里查看</a></p></div><div><p><b>有权下载附件的用户组为:</b><br />&nbsp;&nbsp;&nbsp; {permgroups}',
	'getattachperm_login_nopermission' => '对不起，您还未登录，无权下载本附件。',
	'postattachperm_none_nopermission' => '对不起，您无权上传附件，详细请<a href="home.php?mod=spacecp&ac=credit&op=usergroup" target="_blank">点击这里查看</a></p></div><div>',
	'postattachperm_upgrade_nopermission' => '对不起，您需要升级您所在的用户组后才能上传附件，详细请<a href="home.php?mod=spacecp&ac=credit&op=usergroup" target="_blank">点击这里查看</a></p></div><div><p><b>有权上传附件的用户组为:</b><br />&nbsp;&nbsp;&nbsp; {permgroups}',
	...
	'login_succeed' => '欢迎您回来，{username}。现在将转入登录前页面。 {ucsynlogin} ',
	'login_succeed_inactive_member' => '欢迎您回来，{username}。您的帐号处于非激活状态，现在将转入控制面板。 {ucsynlogin} ',
	'logout_succeed' => '您已退出站点，现在将以游客身份转入退出前页面。 <br /><a href="member.php?mod=clearcookies&formhash={formhash}">[ 清除痕迹 ]</a> {ucsynlogout} ',
	...
	'forum_permforum_nomedal' => '您需要拥有以下勋章才可访问这个版块<br /><br />{forum_permforum_nomedal}',
	...
	'attachment_buy' => '您已成功购买本附件，现在将开始下载“{filename}”。',
	...
	'post_edit_succeed' => '您的帖子编辑成功，现在将转入主题页。<br /><a href="forum.php?mod=forumdisplay&fid={fid}">[ 需要转入主题列表请点击这里 ]</a>',
	'post_reply_succeed' => '非常感谢，您的回复已经发布，现在将转入主题页。<br /><a href="forum.php?mod=forumdisplay&fid={fid}">[ 需要转入主题列表请点击这里 ]</a>',
	...
	'post_newthread_succeed' => '非常感谢，您的主题已经发布，现在将转入主题页。<br /><a href="forum.php?mod=forumdisplay&fid={fid}">[ 需要转入主题列表请点击这里 ]</a>',
	...
	'register_manual_verify' => '非常感谢您的注册，管理员设置了人工验证新注册用户，请等待审核通过，现在将转入个人中心首页。',
	'register_succeed' => '感谢您注册 {bbname}，现在将以会员身份登录站点。',
	'register_activation' => '用户名已经存在',
	'register_activation_message' => '对不起，您输入的用户名 "{username}" 已经存在，请登录站点激活此帐号。',
	...
	'profile_admin_security_invalid' => '作为管理者之一，您需要填写安全提问和答案以保障站点的安全，请返回。',
	...
	'profile_email_verify' => '确认 Email 已经发送，请用邮件中提供的方法激活您的帐号。如果您没有收到我们发送的系统邮件，请点击控制面板首页中的“重新验证 Email 有效性”，或尝试更换另外一个地址。注意：在完成激活之前，根据管理员设置，您将只能以待验证会员的身份访问站点，您可能不能进行发帖等操作。激活成功后，上述限制将自动取消。',
	...
	'credits_policy_lowerlimit' => '对不起，您的{title}不足(小于 {lowerlimit} {unit})。',
	...
	'usergroups_span_invalid' => '对不起，您至少需要支付 {minspan} 天的积分价格，请返回。',
	...
	'trade_credits_no_enough' => '您的 {credittitle} 不足，无法用 {credittitle} 换取商品的优惠，请返回修改。',
	...
	'trade_add_succeed' => '非常感谢，您的商品已经发布，现在将转入商品主题页。<br /><a href="forum.php?mod=post&action=reply&fid={fid}&tid={tid}&addtrade=yes">[ 继续添加商品请点击这里 ]</a><br /><a href="forum.php?mod=forumdisplay&fid={fid}">[ 需要转入主题列表请点击这里 ]</a>',
	...
	'task_up_to_limit' => '对不起，该任务仅限 {tasklimits} 人领取奖励，按照先到先得的原则，您无法领取奖励，请下次再来吧！',
	...
	'task_applied' => '任务申请成功！',
	'task_reward_credit' => '恭喜您完成任务，您已得到的积分奖励如下：{creditbonus}，详情请查阅短消息。',
	'task_reward_magic' => '恭喜您完成任务，您已得到的道具奖励如下：{creditbonus} {bonus} 枚，详情请查阅短消息。',
	'task_reward_medal' => '恭喜您完成任务，您已得到的勋章奖励如下： 有效期 {bonus} 天，详情请查阅短消息。',
	'task_reward_invite' => '恭喜您完成任务，您已得到的邀请码奖励如下：共 {prize} 个 有效期 {bonus} 天，详情请查阅短消息。',
	'task_reward_group' => '恭喜您完成任务，您已得到的特殊用户组奖励如下：用户组 {rewardtext} 有效期 {bonus} 天，详情请查阅短消息。',
	...
	'invite_credits_no_enough' => '<span class="onerror">您的 {{$_G[setting][extcredits]}[{$_G[setting][creditstransextra]}[4]][title]} 不足。</span>',
	...
	'admin_cpanel_noaccess' => '您无权访问管理面板，请重新登录站点，然后重试',
	...
	'group_admin_noallowed' => '您无权限管理此群组。',
	'group_admin_only_one_member' => '只有一个群成员了，不能进行管理。',
	...
	'group_member_level_admin_noallowed' => '您不能管理此级别的成员',
	'group_only_one_moderator' => '只剩最后一个群主了，必须由管理员在后台删除群组。',
	'group_setup_succeed' => '群组设置成功更新。',
	'group_choose_member' => '请返回选择成员。',
	'group_level_cannot_do' => '目前您的群组等级没有此功能。',
	'group_threadtype_only_founder' => '只有群组创始人可以管理主题分类。',
	'group_threadtype_edit_succeed' => '修改主题分类成功。',
	'group_cannot_demise' => '本群组暂无其他管理成员，不能进行转让。',
	'group_demise_choose_receiver' => '您没有选择接收者，请返回。',
	...
	'group_create_usergroup_failed' => '您所在的用户组不能建立群组',
	...
	'no_privilege_realname' => '您需要填写真实姓名后才能进行当前操作，<a href="home.php?mod=spacecp&ac=profile">点这里设置真实姓名</a>',
	'no_privilege_videophoto' => '您需要视频认证通过后才能进行当前操作，<a href="home.php?mod=spacecp&ac=videophoto">点这里进行视频认证</a>',
	'no_open_videophoto' => '目前站点已经关闭视频认证功能',
	'is_blacklist' => '受对方的隐私设置影响，您目前没有权限进行本操作',
	'no_privilege_newbiespan' => '您目前处于见习期间，需要等待 {newbiespan}小时后才能进行本操作',
	'no_privilege_avatar' => '您需要设置自己的头像后才能进行本操作，<a href="home.php?mod=spacecp&ac=avatar">点这里设置</a>',
	'no_privilege_avatar_login' => '您需要登录并设置自己的头像后才能进行本操作',
	'no_privilege_friendnum' => '您需要添加 {friendnum}个好友之后，才能进行本操作，<a href="home.php?mod=spacecp&ac=friend&op=find">点这里添加好友</a>',
	'no_privilege_email' => '您需要验证激活自己的邮箱后才能进行本操作，<a href="home.php?mod=spacecp&ac=profile&op=password">点这里激活邮箱</a>',
	...
	'mail_credit_inadequate' => '您没有足够的积分来完成此次邀请',
	'send_result_succeed' => '邮件已经送出，您的好友可能需要几分钟后才能收到邮件',
	...
	'invite_mtag_ok' => '成功加入该群组，您可以：<a href="home.php?mod=space&do=mtag&tagid=\\1" target="_blank">立即访问该群组</a>',
	...
	'email_input' => '您还没有设置邮箱，请在<a href="home.php?mod=spacecp&ac=profile&op=contact">联系方式</a>中准确填写您的邮箱',
	'email_check_sucess' => '您的邮箱（{email}）验证激活完成了, 请返回',
	...
	'settings_of_your_mtag' => '有了群组才能发话题，你需要先设置一下你的群组。<br>通过群组，您可以结识与你有相同选择的朋友，更可以一起交流话题。<br><br><a href="home.php?mod=spacecp&ac=mtag" class="submit">设置我的群组</a>',
	...
	'invite_code_error' => '对不起，您访问的邀请链接不正确。',
	'invite_code_endtime_error' => '对不起，您访问的邀请链接已经失效。',
	...
	'close_invite' => '对不起，您目前还没有权限来进行邀请好友操作',
	...
	'no_privilege_myapp' => '对不起，该应用不存在或已关闭，您可以<a href="userapp.php?mod=manage&my_suffix=%2Fapp%2Flist">选择其他应用</a>',
	...
	'friend_addconfirm_next' => '您已经跟{username}成为了好友，继续处理下一个好友请求中(<a href="home.php?mod=spacecp&ac=friend&op=request">停止</a>)',
	...
	'has_no_more_present_magic' => '您还没有道具转让许可证，<a id="a_buy_license" href="home.php?mod=spacecp&ac=magic&op=buy&mid=license" onclick="ajaxmenu(event, this.id, 1)">马上去购买</a>',
	...
	'magics_nonexistence' => '您选择的道具不存在，请到<a href="home.php?mod=magic" target="_blank">道具商店</a>购买。',
	...
	'portal_nopermission' => '您没有权限使用门户管理功能',
	...
	'view_article_no_exist' => '指定要查看的文章不存在',

	'topictitle_cannot_be_empty' => '专题名称不能为空',
	...
	'article_delete_invalid_lastpage' => '当前为最后一页，不能被删除',
	'article_push_invalid_repeat' => '已经推送到文章里面了，不能重复推送',
	'article_push_invalid_object' => '指定的信息不能推送',
	'article_push_invalid_private' => '当前日志因隐私设置不能进行文章推送操作',
	'article_push_category_invalid' => '未指定要推送到的模块',
	'article_push_succeed' => '已成功推送文章到指定模块',
	'article_action_invalid' => '请选择要进行的操作',
	'article_not_choose' => '请选择要操作的文章',
	'article_push_not_allowed' => '你没有权限推送文章到该模块',
