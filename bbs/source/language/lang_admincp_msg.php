 ...
 *
 *      $Id: lang_admincp_msg.php 10926 2010-05-18 07:20:53Z xupeng $
 */
...
(
	...
	'setting_ipaccess_invalid' => '操作错误！您必须将自己的 IP 加入到允许访问站点的 IP 列表中，请返回修改。',
	'setting_adminipaccess_invalid' => '操作错误！您必须将自己的 IP 加入到允许访问后台的 IP 列表中，请返回修改。',
	'setting_credits_title_invalid' => '您没有为全部被启用的积分设置积分名称，请返回修改。',
	...
	'setting_extcredits_must_available' => '您需要至少开启一种扩展积分，请返回修改。',
	...
	'threads_forumstick_del_invalid' => '您没有选择要取消置顶的主题，请返回。',
	...
	'threads_forumstick_del_nochoice' => '您没有选择要取消置顶的主题，请返回。',
	...
	'database_export_multivol_succeed' => '恭喜您，全部 {volume} 个备份文件成功创建，备份完成。<br /> {filelist}',
	...
	'styles_import_version_invalid_confirm' => '本风格适用于 Discuz! {cur_version} 与当前版本({set_version})不一致，您确定要安装吗？',
	...
	'plugins_import_identifier_duplicated' => '您要导入的插件({plugin_name})已经安装，请返回。',
	...
	'creditwizard_resetusercredit_warning' => '<font color=\"FF0000\"><b>警告：</b></font>此操作将重置所有用户的扩展积分 extcredits{resetcredit} 为 {initcredits}，您是否确认此操作？',
	...
	'cachethread_dir_noexists' => '对不起，您所指定的目录 {cachethreaddir} 不存在或者不可写！请返回并尝试通过 FTP 将其属性改为 777。',
	...
	'blockstyle_create_succeed' => '创建模块样式成功。',
	'blockstyle_edit_succeed' => '编辑模块样式成功。',
	'blockstyle_should_be_kept' => '每个模块类需要保留至少一个样式',
	'blockstyle_blockclass_not_match' => '选择的新样式和原样式不属于同一模块类',
	'blockstyle_delete_succeed' => '删除模块样式成功。',
	'block_manage_no_access' => '您没有权限管理模块',
	'block_choose_at_least_one_block' => '请至少选择一个模块',
	'blockstyle_manage_no_access' => '您没有权限管理模块样式',
	...
	'blogcategory_manage_no_access' => '您没有权限管理日志分类',
	...
	'albumcategory_manage_no_access' => '您没有权限管理相册分类',
	...
	'postsplit_moving' => '已经移动了 {count} 个主题，共有 {total} 个主题<br /><input type="hidden" name="tids" value="{tids}" />',
	...
	'threadsplit_moving' => '已经移动了 {count} 个主题，共有 {total} 个主题<br /><input type="hidden" name="tids" value="{tids}" />',
	...
	'group_level_update_succeed' => '群组等级成功更新。如您添加了新的等级，<br />请不要忘记修改其相应的设置。',
	...
	'feed_global_add_success' => '全局动态发布成功，请返回',
