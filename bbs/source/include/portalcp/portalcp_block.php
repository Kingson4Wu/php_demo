 ...
 *
 *      $Id: portalcp_block.php 10915 2010-05-18 04:48:02Z monkey $
 */
...
$_GET['styleid'] = !empty($_GET['styleid']) && isset($theclass['style'][$_GET['styleid']])
		? $_GET['styleid']
...
if($op == 'block') {
	...
	if(submitcheck('blocksubmit')) {
		...
		$_POST['styleid'] = isset($theclass['style'][$_POST['styleid']]) ?
							$_POST['styleid'] : key($theclass['style']);
		...
		$setarr = array(
			...
			'shownum' => $_POST['shownum'] > 0 ? $_POST['shownum'] : 10,
