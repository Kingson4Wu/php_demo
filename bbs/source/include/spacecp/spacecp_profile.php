 ...
 *
 *      $Id: spacecp_profile.php 10739 2010-05-14 07:02:14Z zhengqingpeng $
 */
...
$operation = in_array($_GET['op'], array('base', 'contact', 'edu', 'work', 'info', 'bbs', 'password')) ? trim($_GET['op']) : 'base';
...
if($operation == 'password') {
	...
	$privacy = array_merge($_G['setting']['privacy'], $privacy);
