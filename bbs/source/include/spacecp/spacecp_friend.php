 ...
 *
 *      $Id: spacecp_friend.php 10793 2010-05-17 01:52:12Z xupeng $
 */
...
if($op == 'add') {
	...
	if(submitcheck('changegroupsubmit')) {
		...
		friend_cache($_G['uid']);
		showmessage('do_success', dreferer(), array('gid'=>intval($_POST['group'])), array('showdialog'=>1, 'showmsg' => true, 'closetime' => 1));
	}
