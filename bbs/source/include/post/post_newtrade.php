 ...
 *
 *      $Id: post_newtrade.php 10627 2010-05-13 03:47:12Z monkey $
 */
...
if($modnewthreads) {
	...
	if(!empty($_G['gp_addfeed']) && $_G['forum']['allowfeed'] && !$isanonymous) {
		...
		$feed['body_data'] = array(
			'itemname'=> "<a href=\"$_G[siteurl]forum.php?mod=viewthread&do=tradeinfo&tid=$tid&pid=$pid\">$_G[gp_item_name]</a>",
