 ...
 *
 *      $Id: home_editor.php 9884 2010-05-05 07:04:43Z wangjinbo $
 */
...
<a href="javascript:;" class="icoSwitchMdi" title="<?=lang('home/template', 'editor_switch_media')?>" onClick="changeEditType(true);return false;"></a>
</div>
</div>
</td></tr></table>
</td></tr></table>
...
<div class="toobar">
<div class="icons tble">
<a href="javascript:;" class="icoCut" title="<?=lang('home/template', 'editor_cut')?>" onClick="format('Cut');return false;"></a>
<a href="javascript:;" class="icoCpy" title="<?=lang('home/template', 'editor_copy')?>" onClick="format('Copy');return false;"></a>
<a href="javascript:;" class="icoPse" title="<?=lang('home/template', 'editor_paste')?>" onClick="format('Paste');return false;"></a>
<div class="sepline"></div>
<a href="javascript:;" class="icoFfm" id="imgFontface" title="<?=lang('home/template', 'editor_font')?>" onClick="fGetEv(event);fDisplayElement('fontface','');return false;"></a>
<a href="javascript:;" class="icoFsz" id="imgFontsize" title="<?=lang('home/template', 'editor_fontsize')?>" onClick="fGetEv(event);fDisplayElement('fontsize','');return false;"></a>
<a href="javascript:;" class="icoWgt" onClick="format('Bold');return false;" title="<?=lang('home/template', 'editor_fontbold')?>"></a>
<a href="javascript:;" class="icoIta" title="<?=lang('home/template', 'editor_fontitalic')?>" onClick="format('Italic');return false;"></a>
<a href="javascript:;" class="icoUln" onClick="format('Underline');return false;" title="<?=lang('home/template', 'editor_fontunderline')?>"></a>
<a href="javascript:;" class="icoFcl" title="<?=lang('home/template', 'editor_funtcolor')?>" onClick="foreColor(event);return false;" id="imgFontColor"></a>
<a href="javascript:;" class="icoAgn" id="imgAlign" onClick="fGetEv(event);fDisplayElement('divAlign','');return false;" title="<?=lang('home/template', 'editor_align')?>"></a>
<a href="javascript:;" class="icoLst" id="imgList" onClick="fGetEv(event);fDisplayElement('divList','');return false;"title="<?=lang('home/template', 'editor_list')?>"></a>
<a href="javascript:;" class="icoOdt" id="imgInOut" onClick="fGetEv(event);fDisplayElement('divInOut','');return false;" title="<?=lang('home/template', 'editor_indent')?>"></a>
<div class="sepline"></div>
<a href="javascript:;" class="icoUrl" id="icoUrl" onClick="createLink(event, 1);return false;" title="<?=lang('home/template', 'editor_hyperlink')?>"></a>
<a href="javascript:;" class="icoMoveUrl" onClick="clearLink();return false;" title="<?=lang('home/template', 'editor_remove_link')?>"></a>
<a href="javascript:;" class="icoImg" id="icoImg" onClick="createImg(event, 1);return false;" title="<?=lang('home/template', 'editor_link_image')?>"></a>
<a href="javascript:;" class="icoSwf" id="icoSwf" onClick="createFlash(event, 1);return false;" title="<?=lang('home/template', 'editor_link_flash')?>"></a>
<a href="javascript:;" class="icoFace" id="faceBox" onClick="faceBox(event);return false;" title="<?=lang('home/template', 'editor_insert_smiley')?>"></a>
<?php if($doodle) { ?>
<a href="javascript:;" class="icoDoodle" id="doodleBox" onClick="doodleBox(event, this.id);return false;" title="<?=lang('home/template', 'editor_doodle')?>"></a>
<?php }?>
<?php if($isportal) {?>
<a href="javascript:;" class="icoPage" id="newPage" onClick="pageBreak();return false;" title="<?=lang('home/template', 'editor_pagebreak')?>"></a>
<a href="javascript:;" class="icoDown" id="newPage" onClick="parent.downRemoteFile();return false;" title="<?=lang('home/template', 'editor_download_remote')?>"></a>
<?php }?>
<a href="javascript:;" class="icoRenew" onClick="renewContent();return false;" title="<?=lang('home/template', 'editor_restore')?>"></a>
<?php if($allowhtml) {?>
...
<a href="javascript:;" class="icoSwitchTxt" title="<?=lang('home/template', 'editor_switch_text')?>" onClick="changeEditType(false, event);return false;"></a>
</div>
</div>
...
<div class="icons tble">
<a href="javascript:;" class="icoSwitchMdi" title="<?=lang('home/template', 'editor_switch_media')?>" onClick="changeEditType(true, event);return false;"></a>
</div>
</div>
</td>
</tr>
...
<a href="javascript:;" onClick="fontname(this)" class="n" style="font:normal 12px '<?=lang('home/template', 'editor_font_song')?>';"><?=lang('home/template', 'editor_font_song')?></a>
<a href="javascript:;" onClick="fontname(this)" class="n" style="font:normal 12px '<?=lang('home/template', 'editor_font_hei')?>';"><?=lang('home/template', 'editor_font_hei')?></a>
<a href="javascript:;" onClick="fontname(this)" class="n" style="font:normal 12px '<?=lang('home/template', 'editor_font_kai')?>';"><?=lang('home/template', 'editor_font_kai')?></a>
<a href="javascript:;" onClick="fontname(this)" class="n" style="font:normal 12px '<?=lang('home/template', 'editor_font_li')?>';"><?=lang('home/template', 'editor_font_li')?></a>
<a href="javascript:;" onClick="fontname(this)" class="n" style="font:normal 12px '<?=lang('home/template', 'editor_font_you')?>';"><?=lang('home/template', 'editor_font_you')?></a>
...
<a href="javascript:;" onClick="fontsize(1,this)" class="n" style="font-size:xx-small;line-height:120%;"><?=lang('home/template', 'editor_fontsize_xxsmall')?></a>
<a href="javascript:;" onClick="fontsize(2,this)" class="n" style="font-size:x-small;line-height:120%;"><?=lang('home/template', 'editor_fontsize_xsmall')?></a>
<a href="javascript:;" onClick="fontsize(3,this)" class="n" style="font-size:small;line-height:120%;"><?=lang('home/template', 'editor_fontsize_small')?></a>
<a href="javascript:;" onClick="fontsize(4,this)" class="n" style="font-size:medium;line-height:120%;"><?=lang('home/template', 'editor_fontsize_medium')?></a>
<a href="javascript:;" onClick="fontsize(5,this)" class="n" style="font-size:large;line-height:120%;"><?=lang('home/template', 'editor_fontsize_large')?></a>
</div>

<div id="divList" class="eMenu" style="display:none;top:35px;left:26px;width:60px;height:40px;"><a href="javascript:;" onClick="format('Insertorderedlist');fHide(this.parentNode)" class="n"><?=lang('home/template', 'editor_list_order')?></a><a href="javascript:;" onClick="format('Insertunorderedlist');fHide(this.parentNode)" class="n"><?=lang('home/template', 'editor_list_unorder')?></a></div>
<div id="divAlign" class="eMenu" style="display:none;top:35px;left:26px;width:60px;height:60px;"><a href="javascript:;" onClick="format('Justifyleft');fHide(this.parentNode)" class="n"><?=lang('home/template', 'editor_align_left')?></a><a href="javascript:;" onClick="format('Justifycenter');fHide(this.parentNode)" class="n"><?=lang('home/template', 'editor_align_center')?></a><a href="javascript:;" onClick="format('Justifyright');fHide(this.parentNode)" class="n"><?=lang('home/template', 'editor_align_right')?></a></div>
<div id="divInOut" class="eMenu" style="display:none;top:35px;left:26px;width:60px;height:40px;"><a href="javascript:;" onClick="format('Indent');fHide(this.parentNode)" class="n"><?=lang('home/template', 'editor_indent_inc')?></a><a href="javascript:;" onClick="format('Outdent');fHide(this.parentNode)" class="n"><?=lang('home/template', 'editor_indent_dec')?></a></div>

<div id="dvForeColor" class="eMenu" style="display:none;top:35px;left:26px;width:90px;">
<a href="javascript:;" onClick="format(gSetColorType,'#800000')" class="n cs fRd1"><b class="cb"></b><span><?=lang('home/template', 'editor_color_darkred')?></span></a>
<a href="javascript:;" onClick="format(gSetColorType,'#800080')" class="n cs fRd2"><b class="cb"></b><span><?=lang('home/template', 'editor_color_purple')?></span></a>
<a href="javascript:;" onClick="format(gSetColorType,'#F00000')" class="n cs fRd3"><b class="cb"></b><span><?=lang('home/template', 'editor_color_red')?></span></a>
<a href="javascript:;" onClick="format(gSetColorType,'#F000F0')" class="n cs fRd4"><b class="cb"></b><span><?=lang('home/template', 'editor_color_pink')?></span></a>
<a href="javascript:;" onClick="format(gSetColorType,'#000080')" class="n cs fBu1"><b class="cb"></b><span><?=lang('home/template', 'editor_color_darkblue')?></span></a>
<a href="javascript:;" onClick="format(gSetColorType,'#0000F0')" class="n cs fBu2"><b class="cb"></b><span><?=lang('home/template', 'editor_color_blue')?></span></a>
<a href="javascript:;" onClick="format(gSetColorType,'#00F0F0')" class="n cs fBu3"><b class="cb"></b><span><?=lang('home/template', 'editor_color_lakeblue')?></span></a>
<a href="javascript:;" onClick="format(gSetColorType,'#008080')" class="n cs fGn1"><b class="cb"></b><span><?=lang('home/template', 'editor_color_greenblue')?></span></a>
<a href="javascript:;" onClick="format(gSetColorType,'#008000')" class="n cs fGn2"><b class="cb"></b><span><?=lang('home/template', 'editor_color_green')?></span></a>
<a href="javascript:;" onClick="format(gSetColorType,'#808000')" class="n cs fGn3"><b class="cb"></b><span><?=lang('home/template', 'editor_color_olives')?></span></a>
<a href="javascript:;" onClick="format(gSetColorType,'#00F000')" class="n cs fGn4"><b class="cb"></b><span><?=lang('home/template', 'editor_color_lightgreen')?></span></a>
<a href="javascript:;" onClick="format(gSetColorType,'#F0C000')" class="n cs fYl1"><b class="cb"></b><span><?=lang('home/template', 'editor_color_orange')?></span></a>
<a href="javascript:;" onClick="format(gSetColorType,'#000000')" class="n cs fBk1"><b class="cb"></b><span><?=lang('home/template', 'editor_color_black')?></span></a>
<a href="javascript:;" onClick="format(gSetColorType,'#808080')" class="n cs fBk2"><b class="cb"></b><span><?=lang('home/template', 'editor_color_grey')?></span></a>
<a href="javascript:;" onClick="format(gSetColorType,'#C0C0C0')" class="n cs fBk3"><b class="cb"></b><span><?=lang('home/template', 'editor_color_silver')?></span></a>
<a href="javascript:;" onClick="format(gSetColorType,'#FFFFFF')" class="n cs fWt0"><b class="cb"></b><span><?=lang('home/template', 'editor_color_white')?></span></a>
</div>
...
<div id="createUrl" class="eMenu" style="display:none;top:35px;left:26px;width:300px;font-size:12px">
	<?=lang('home/template', 'editor_prompt_textlink')?>:<br/>
	<input type="text" id="insertUrl" name="url" value="http://" class="t_input" style="width: 190px;"> <input type="button" onclick="createLink();" name="createURL" value="<?=lang('home/template', 'editor_ok')?>" class="submit" /> <a href="javascript:;" onclick="fHide($('createUrl'));"><?=lang('home/template', 'editor_cancel')?></a>
</div>
<div id="createImg" class="eMenu" style="display:none;top:35px;left:26px;width:300px;font-size:12px">
	<?=lang('home/template', 'editor_prompt_imagelink')?>:<br/>
	<input type="text" id="imgUrl" name="imgUrl" value="http://" class="t_input" style="width: 190px;" /> <input type="button" onclick="createImg();" name="createURL" value="<?=lang('home/template', 'editor_ok')?>" class="submit" /> <a href="javascript:;" onclick="fHide($('createImg'));"><?=lang('home/template', 'editor_cancel')?></a>
</div>
<div id="createSwf" class="eMenu" style="display:none;top:35px;left:26px;width:400px;font-size:12px">
	<?=lang('home/template', 'editor_prompt_videolink')?>:<br/>
	<select name="vtype" id="vtype">
		<option value="0"><?=lang('home/template', 'editor_prompt_video_flash')?></option>
		<option value="1"><?=lang('home/template', 'editor_prompt_video_media')?></option>
		<option value="2"><?=lang('home/template', 'editor_prompt_video_real')?></option>
	</select>
	<input type="text" id="videoUrl" name="videoUrl" value="http://"  class="t_input" style="width: 200px;" />
	<input type="button" onclick="createFlash();" name="createURL" value="<?=lang('home/template', 'editor_ok')?>" class="submit" />
	<a href="javascript:;" onclick="fHide($('createSwf'));"><?=lang('home/template', 'editor_cancel')?></a>
</div>
