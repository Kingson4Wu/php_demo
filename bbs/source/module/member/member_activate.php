 ...
 *
 *      $Id: member_activate.php 9491 2010-04-29 02:49:46Z zhaoxiongfei $
 */
...
if($_G['gp_uid'] && $_G['gp_id']) {
	...
	if($operation == 2 && $idstring == $_G['gp_id']) {
		...
		DB::query("UPDATE ".DB::table('common_member')." SET groupid='".DB::result($query, 0)."' WHERE uid='$member[uid]'");
		...
		showmessage('activate_illegal', NULL);
	}
