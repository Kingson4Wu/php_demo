 ...
 *
 *      $Id: adv_headerbanner.php 9396 2010-04-28 08:27:33Z monkey $
 */
...
class adv_headerbanner {
	...
	function evalcode($adv) {
		return array(
			...
			'create' => '$extra = $evalcode[\'height\'] ? \' style="line-height:\'.$evalcode[\'height\'].\'px;height:\'.$evalcode[\'height\'].\'px"\' : \'\';$adcode = $codes[$adids[array_rand($adids)]];',
