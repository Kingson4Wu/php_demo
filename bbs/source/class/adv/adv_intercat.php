 ...
 *
 *      $Id: adv_intercat.php 7169 2010-03-30 06:34:18Z monkey $
 */
...
class adv_intercat {
	...
	function evalcode() {
		return array(
			'check' => '
			if($parameter[\'position\'] && $params[2] != $parameter[\'position\'] || $_G[\'basescript\'] == \'forum\' && $parameter[\'fids\'] && !in_array($_G[\'gp_gid\'], $parameter[\'fids\'])) {
				$checked = false;
			}',
