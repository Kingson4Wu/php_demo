 ...
 *
 *      $Id: class_image.php 9074 2010-04-26 11:23:52Z xupeng $
 */
...
class image {
	...
	function image() {
		...
		$this->param = array(
			...
			'watermarkquality'	=> $s['watermarkquality']
		);
	}
	...
	function Watermark($source, $target = '') {
		...
		$this->param['watermarkfile'] = './static/image/common/'.($this->param['watermarktype'] == 'png' ? 'watermark.png' : 'watermark.gif');
