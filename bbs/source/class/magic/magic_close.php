 ...
 *
 *      $Id: magic_close.php 9008 2010-04-26 05:19:34Z monkey $
 */
...
class magic_close {
	...
	function usesubmit() {
		...
		updatemagicthreadlog($_G['gp_tid'], $this->magic['magicid'], 'CLS', $expiration);
		...
		showmessage(lang('magic/close', 'close_succeed'), dreferer(), array(), array('showdialog' => 1, 'locationtime' => 1));
	}
