 ...
 *
 *      $Id: class_admincp.php 7023 2010-03-28 06:34:42Z cnteacher $
 */
...
class discuz_admincp
{
	...
	function check_cpaccess() {
		...
		if($this->cpaccess == 1) {
			...
			DB::update('common_admincp_session', array('dateline' => TIMESTAMP, 'ip' => $this->core->var['clientip'], 'errorcount' => -1), "uid={$this->adminuser['uid']}");
		}
	...
	function check_admin_login() {
		...
		if($ucresult[0] > 0) {
			...
			DB::update('common_admincp_session', array('dateline' => TIMESTAMP, 'ip' => $this->core->var['clientip'], 'errorcount' => $errorcount), "uid={$this->adminuser['uid']}");
		}
	}
