...
DROP TABLE IF EXISTS pre_common_block_item_archive;
CREATE TABLE pre_common_block_item_archive (
  bid mediumint(8) unsigned NOT NULL DEFAULT '0',
  id int(10) unsigned NOT NULL DEFAULT '0',
  idtype varchar(255) NOT NULL DEFAULT '',
  itemtype tinyint(1) NOT NULL DEFAULT '0',
...
CREATE TABLE pre_common_block_permission (
  bid mediumint(8) unsigned NOT NULL DEFAULT '0',
  uid mediumint(8) unsigned NOT NULL DEFAULT '0',
  allowdata tinyint(1) NOT NULL DEFAULT '0',
  allowsetting tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (bid,uid),
  KEY uid (uid)
) TYPE=MyISAM;
...
CREATE TABLE pre_common_member_status (
  ...
  groupinvitations smallint(6) unsigned NOT NULL DEFAULT '0',
  activityinvitations smallint(6) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE pre_common_smiley (
  ...
  `type` enum('smiley','stamp') NOT NULL DEFAULT 'smiley',
...
CREATE TABLE pre_forum_forum (
  ...
  allowside tinyint(1) NOT NULL DEFAULT '1',
...
CREATE TABLE pre_forum_groupinvite (
  ...
  dateline int(10) unsigned NOT NULL DEFAULT '0',
  UNIQUE KEY ids (fid,inviteuid,uid),
  KEY dateline (dateline)
) TYPE=MyISAM;
